...
{
	//ROOMS
	entity* CenterRoom = new Rooms("Center of the room", "A lightly place in the middle of the room, there's nothing interesting to do, but you can go everywhere from here");
	entity* Heater = new Rooms("In Front of the Heater", "A warm place under some book shelves, between the wardrobe and the desk");
	entity* UnderWardrobe = new Rooms("Under the wardrobe", "Your house, it is a wet but homely place");
	entity* FrontWardrobe = new Rooms("Front of the wardrobe", "A large and empty place in front of your home");
	entity* BehindDoor = new Rooms("Behind the Door", "A really dark place, you will need something to watch if there's something in front of you");
	entity* BookShelves = new Rooms("Book Shelves", "A high place with some adventure books and comics, high enough to reach the wardrobe top");
	entity* Desk = new Rooms("Desk", "A lightly place next to the window with a half-eated sandwich, a laptop and some jambled stuff");
	entity* UnderBed = new Rooms("Under the Bed", "This place is a mess, really dirty and full of dust, you can also see a tiny door");
	entity* Bed = new Rooms("Bed", "Really soft and comfortable place, the bedside table seems reacheable from here");
	entity* MouseCave = new Rooms("Mouse cave", "A place which stinks of cheese, there is a mouse trap here but seems that the animal is smarter than the humans");
	entity* BedsideTable = new Rooms("Bedside Table", "Near the bed, there is a plate with some snacks and another with the rests of those snacks");
	entity* AboveWardrobe = new Rooms("Above the Wardrobe", "A dusty and dark place, your brother is here waiting for you to fight the spider ans save him");
	entity* UnderDesk = new Rooms("Under the Desk", "A shadowy place, home of Rusty the old man, you can also reach some drawers from here");
	...
	//PLAYER
	player = new Player(nullptr, nullptr, Desk, 2);

	//ITEMS	
	entity* PoweredHook = new item("PoweredHook", "This awesome improved hook will help you to reach the wardrobe roof", false, nullptr, nullptr, nullptr, ITEM);
	entity* NutsGunLoaded = new item("NutsGunLoaded", "Fully reloaded and ready to shoot", false, nullptr, nullptr, nullptr, ITEM);
	entity* Catapult = new item("Catapult", "Perfect to reach the wardrobe roof, you should find a clear place to use it", false, nullptr, nullptr, nullptr, ITEM);
	entity* FireNeedle = new item("FireNeedle", "Improved needle with a incandescent needle tip, it is a super awesome weapon", false, nullptr, nullptr, nullptr, ITEM);
	entity* NutsGun = new item("NutsGun", "This powerfull weapon is perfect to fight from distance, but you have no ammo", false, nullptr, NutsGunLoaded, nullptr, ITEM);
	entity* Hook = new item("Hook", "This hook will help you to reach higher positions", false, nullptr, PoweredHook, nullptr, ITEM);
	entity* BlueWire = new item("PenWire", "A elastic wire that can be used to create new items", true, Desk, NutsGun, PoweredHook, ITEM);
	entity* BlackPlastic = new item("BlackPlastic", "This plastic have been used as a blowgun", true, Desk, NutsGun, nullptr, ITEM);
	entity* Shoelace = new item("Shoelace", "This item is usefull to craft recheable items", true, UnderBed, Hook, Catapult, ITEM);
	entity* Needle = new item("Needle", "A sharp needle, that can be a nice weapon", true, BehindDoor, Hook, FireNeedle, ITEM);
	entity* MouseTrap = new item("MouseTrap", "Seems that the cheese have been eaten, but the mouse is still alive", true, MouseCave, Catapult, nullptr, ITEM);
	entity* Nuts = new item("Nuts", "A delicious snack for humans", true, BedsideTable, NutsGunLoaded, nullptr, ITEM);
	entity* MatchStick = new item("Matchstick", "A usefull matchstick that can provide light and heat", true, Desk, FireNeedle, nullptr, ITEM);
	entity* Box = new item("Box", "This box can store items",true, Desk, nullptr, nullptr, BOX);
